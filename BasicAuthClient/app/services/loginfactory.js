(function() {
    ...
    angular.module("app").service('loginFactory', function($http, $cookies, authService) {
    ...
    var basicCredentials = $cookies.get('basicCredentials');
    if (basicCredentials) {
    ...
    return {
        setUserNameAndPassword: function(userName, password) {
            ...
            $cookies.put('basicCredentials', encodedUserNameAndPassword);
            
            $http.defaults.headers.common['Authorization'] = 'Basic ' + encodedUserNameAndPassword;
            authService.loginConfirmed();
        },
        isLoggedIn: function() {
            return $cookies.get('basicCredentials') !== undefined;
        },
        logOut: function() {
            $cookies.remove('basicCredentials');
